...
> {
  ...
  unsubscribe = (willUnmount: boolean) => {}
  boundEventBusFunctions = false
  ...
  attachRef = (eventBus: EventBus) => {
    ...
    if (this.containerNode) {
      ...
      if (!this.boundEventBusFunctions) {
        eventBus.on("textlayerrendered", this.onTextLayerRendered.bind(this))
        eventBus.on("pagesinit", this.onDocumentReady.bind(this))
        this.boundEventBusFunctions = true
      }
      ...
      this.unsubscribe = (willUnmount: boolean) => {
        if (willUnmount) {
          eventBus.off("pagesinit", this.onDocumentReady)
          eventBus.off("textlayerrendered", this.onTextLayerRendered)
          this.boundEventBusFunctions = false
        }
